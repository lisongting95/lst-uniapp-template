...
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart.js */ 50));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default); //分块
...
var $u = _vue.default.prototype.$u;
...
var actions = {
  ...
  // 测试
  testAction: function testAction(_ref)


  {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var commit, state, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit, state = _ref.state;
              console.log('$u -->', $u);_context.next = 4;return (
                $u.m.config.getConfig());case 4:res = _context.sent;
              console.log("action res -->", res);case 6:case "end":return _context.stop();}}}, _callee);}))();
  },
  ...
  // 添加到购物车（增）
  addCartGoods: function addCartGoods(_ref3,
  ...
  changeCartList: function changeCartList(_ref4,
...
var mutations = {
  ...
  commitCartNum: function commitCartNum(state, data) {
    ...
    var cartNum = uni.getStorageSync('cartNum') ? uni.getStorageSync('cartNum') : data;
...
var getters = {
  ...
  testGetterYo: function testGetterYo(state) {
